codeunit 50129 ALF_Tracker_for_Adjust_AddData
{
    ...
    begin
        ...
        //P-INV+    Posted Purchase Invoice	BPI100000000	BPI999999999
        //P-ORD	    Purchase Order	        BPO100000000	BPO999999999
        //P-RCPT	Purchase Receipt	    BPR100000000	BPR999999999
        //S-INV+	Posted Sales Invoice	BSI100000000	BSI999999999
        //S-ORD	    Sales Order	            BSO100000000	BSO999999999
        //S-SHPT	Sales Shipment	        BSS100000000	BSS999999999
    ...
    begin
        ...
        MESSAGE('Created and Posted %1 Sales Orders and %1 Purchase Orders. Elapsed Time: %2',DOCNUMBER,EndTime-StartTime);
    end;
}
